...
export default function GooglePillButton({ role, text = 'Sign in with Google', onGoogleSuccess, onError }) {
  ...
  return (
    <button type="button" className="ob2-google-btn" onClick={() => login()}>
