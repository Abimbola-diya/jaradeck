...
function createContinuationVariants(pathLength) {
  return {
    normal: {
      pathLength: 0,
...
const EyeOffIcon = forwardRef(
  ({ onMouseEnter, onMouseLeave, className = "", size = 20, stroke = "currentColor", ...props }, ref) => {
    ...
    return (
      <div
        ...
        style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', color: stroke }}
        {...props}
      >
        <svg
