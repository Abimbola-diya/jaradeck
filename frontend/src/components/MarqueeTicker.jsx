...
const ALL_PHRASES_ROW1 = [
  ...
  { text: "Ghostwriter for books you keep talking about writing", shape: 'four_star', color: '#059669' },
  ...
  { text: "Voiceover artist without the fake oyinbo accent", shape: 'four_star', color: '#10B981' },
  ...
  { text: "Frontend dev that actually tests on mobile screens", shape: 'sparkle', color: '#FF1744' },
